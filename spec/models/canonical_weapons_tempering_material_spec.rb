...
RSpec.describe CanonicalWeaponsTemperingMaterial, type: :model do
  describe 'validations' do
    ...
    describe 'canonical weapon and canonical material' do
      ...
      it 'forms a unique combination' do
        create(:canonical_weapons_tempering_material, canonical_weapon: weapon, canonical_material: material)
        model = build(:canonical_weapons_tempering_material, canonical_weapon: weapon, canonical_material: material)
